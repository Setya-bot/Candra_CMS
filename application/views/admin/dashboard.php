...
<!-- <div class="row">
    ...
    <div class="card overflow-hidden hover-img">
        ...
        <a href="javascript:void(0)">
            <img src="<?= site_url('assets/SEODash-1.0.0') ?>/images/blog/blog-img2.jpg" class="card-img-top"
            alt="matdash-img">
        </a>
        <span
            class="badge text-bg-light text-dark fs-2 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
            min Read</span>
        <img src="<?= site_url('assets/SEODash-1.0.0') ?>/images/profile/1.png" alt="matdash-img"
